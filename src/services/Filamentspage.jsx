...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── EDITORIAL HERO ── */
  .f-hero {
    padding: clamp(1.5rem, 4vw, 4rem) clamp(1.5rem, 5vw, 6rem);
...
const products = [
  { type: "Standard", name: "PLA Filament", badge: "Bestseller", specs: ["1.75mm", "2.85mm"], img: "https://images.unsplash.com/photo-1609230787490-7a0e9e8c3a5e?w=600&q=80" },
  ...
  { type: "Specialty", name: "TPU Flexible", badge: "Flexible", specs: ["1.75mm"], img: "https://images.unsplash.com/photo-1581093196277-9f6e9b964f4c?w=600&q=80" },
  ...
  { type: "Engineering", name: "Nylon PA12", badge: "Advanced", specs: ["1.75mm", "2.85mm"], img: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80" },
];
      ...
      <div className="filaments-page">
        ...
        <section className="f-hero">
          <div className="f-hero-top">
            <div className="f-brand">Filament Division</div>
            <div className="f-tagline">Premium 3D Printing Filaments</div>
            <div className="f-issue">Collection 2025</div>
          </div>
        ...
        <div className="f-img-strip">
          <img src="https://images.unsplash.com/photo-1607874963930-412c96571c21?w=900&q=80" alt="Filament spool" />
        ...
        <section className="f-apps">
          <div className="f-apps-visual">
            <img
              src="https://images.unsplash.com/photo-1609230787490-7a0e9e8c3a5e?w=900&q=80"
