      ...
      <div className="pellets-page">
        ...
        <section className="hero">
          ...
          <div className="hero-right">
            <img
              src="https://images.unsplash.com/photo-1608502952162-11fd7261f31e?w=1200&q=80"
              alt="Plastic pellets"
            />
        ...
        <section className="intro-section" id="specs">
          ...
          <div className="intro-image-wrap">
            <img
              src="https://images.unsplash.com/photo-1530982011887-3cc11cc85693?w=900&q=80"
              alt="Pellet production"
            />
        ...
        <div className="img-break">
          <img
            src="https://images.unsplash.com/photo-1581093196277-9f6e9b964f4c?w=1600&q=80"
